...
#+BEGIN_SRC python :session python-session :results value silent :exports results
  ...
  party_id_plot.set(xlabel='Party ID', ylabel='Count')
  party_id_plot = party_id_plot.get_figure()
  ...
  plt.figure()
  equal_wealth_plot = sns.countplot(x='equal_wealth', data=gss)
  equal_wealth_plot.set(xlabel='Equal wealth', ylabel='Count')
  equal_wealth_plot.get_figure()
...
#+BEGIN_SRC python :session python-session :results value silent :exports results
  ...
  plt.figure()
  ideology_plot = sns.countplot(x='polviews', data=gss)
  ideology_plot.set(xlabel='Ideology', ylabel='Count')
  ideology_plot = ideology_plot.get_figure()
...
#+BEGIN_SRC python :session python-session :results value silent :exports results
  ...
  female_home_plot = sns.countplot(hue='fefam',
                                   x='sex',
                                   data=gss)
  female_home_plot.set(huelabel='')
  female_home_plot = female_home_plot.get_figure()
  ...
  female_equalwealth_plot = sns.countplot(x='sex', 
                                          hue='equal_wealth',
                                          data=gss)
  female_equalwealth_plot = female_equalwealth_plot.get_figure()
