...
\node (court-appeals) [startstop, below left = 0.75cm and 0.75cm of  supreme-court] {Court of
  Appeals} ; 
...
\node (state-supreme) [startstop, below right= 0.75cm and 0.75cm of supreme-court] {State supreme court};
\node (state-appeals) [startstop, below of = state-supreme] {State appellate courts}; 
\node (state-trial) [startstop, below of =  state-appeals] {State
  trial courts};
