...
\node (court-appeals) [startstop, below left of=  supreme-court] {Court of
  Appeals} ; 
...
\node (state-supreme) [startstop, below right= 2cm and 2cm of supreme-court] {State supreme court};
