...
#   turnout = pd.read_csv('../data/voter-turnout-from-idea.csv')
#   sns.factorplot(x='Year', y='Voter Turnout (%)',
#                  hue='Country', col='Election type', data=turnout)
# #+END_SRC
...
- The Federal Election Commission (*FEC*) calls the election the
  two-year period leading up to the war
