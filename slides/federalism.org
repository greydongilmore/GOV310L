...
** Vetos over time
#+BEGIN_SRC R :session R-session :results value graphics :file ../figures/vetos.pdf :exports results 
  vetos %>%
...
** Recent vetos
#+BEGIN_SRC R :session R-session :results value graphics :file ../figures/vetos-recent.pdf :exports results 
...
#+BEGIN_SRC  R :session R-session :results value graphics :file ../figures/veto-overrides.pdf :exports results 
  vetos %>%
...
#+BEGIN_SRC  R :session R-session :results value graphics :file ../figures/veto-override-percent.pdf :exports results 
  vetos %>%
